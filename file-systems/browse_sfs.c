...
// This program is used to browse the filesystem.

// To instead use "mount", a kernel module can be developed instead:
// https://sysplay.github.io/books/LinuxDrivers/book/Content/Part22.html

// For changing permissions, reading a file, writing a file, see:
// https://sysplay.github.io/books/LinuxDrivers/book/Content/Part20.html

// Since everything is a file in linux, the program can easily
// be modified to instead browse a block device like the one
