...
// partition.c and partition.h provide the functionality
// to emulate the various partition tables on the disk on RAM.
// The code in this is responsible for the partition information
// like number, type, size, etc that is shown up on the disk on
// RAM using fdisk.
...
static PartTable def_part_table =
{
	...
	},
	{
		...
		start_head: 0x00,
		start_sec: 0x1,
		start_cyl: 0x0A, // extended partition start cylinder (BR location), matches 0x0A in "def_log_part_br_cyl"
