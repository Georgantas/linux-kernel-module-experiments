...
/* Disk on RAM Driver */
// ram_block.c is the core block driver implementation
// exposing the disk on RAM as the block device files
// (/dev/rb) to the user-space
...
/* 
 * Actual Data transfer, called by rb_request
 */
