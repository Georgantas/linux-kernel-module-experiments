...
// ram_device.c and ram_device.h abstract the underlying RAM operations
// like vmalloc/vfree, memcpy, etc, providing disk operation APIs like
// init/cleanup, read/write, etc. 
